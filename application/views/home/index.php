...
<div class="header" id="head">
			   ...
			   <div class="wmuSliderWrapper">
				   <article style="position: absolute; width: 100%; opacity: 0;">
				   	<div class="banner-wrap">
				   	       	<div class="banner_center">
				   		 		<h1>Hi,</h1>
				   		 		<h2>Welcome to <span>my biodata</span></h2>
				   		 		<h2>Website</h2>
				   		 		</div>
				   		 </div>
					</article>
				   <article style="position: relative; width: 100%; opacity: 1;">
				   	      ...
				   	      <div class="banner_center">
				   		 		...
				   		 		<h2>Explore the <span>"ABOUT"</span></h2>
				   		 		<h2>Section now.</h2>
				   		 		</div>
				   		  </div>
				   </article>
				   <article style="position: absolute; width: 100%; opacity: 0;">
				   	  	<div class="banner-wrap">
				   	       <div class="banner_center">
				   		 		...
				   		 		<h2>Check the <span>"CONTACT"</span> section</h2>
				   		 		<h2>for available contact.</h2>
				   		 		</div>
				   		 </div>
					 </article>
				 </div>
	...
	<div class="container">
		<div class="about-header">
			...
			<div class="about-text">
					<p>Hello. My name is Yaniar Pradityas Effendi. I'm a 21-year-old college student. I'm
            in my third year of studies towards a bachelor's in Informatics at Institut
            Teknologi Sepuluh Nopember (ITS), Surabaya, Indonesia.
            <br><br>
            I was born in Gresik, East Java, Indonesia, and have been living there
            up until now. My MBTI personality type result is INTJ-A.</p>
			</div>
			<div class="clearfix"></div>
			</div>
	...
	<div class="arrow1">
	<a href="#contact" class="scroll"><img src="assets/images/arrow1.png" alt=""/></a>
					</div>
	</div>
	</div>
	<!-- about-section-ends -->
	<div class="footer-section" id="contact" id="contact">
        ...
        <div class="white">
          ...
          <p>Kebomas, Gresik, East Java, Indonesia 61122</p>
          <!-- <p>Phone:</p> -->
          <div class="icon">
                <i class="fa fa-phone"></i>
          </div>
          <p>+62 812 1757 3735</p>
          <!-- <p>E-mail:</p> -->
          <div class="icon">
                <i class="fa fa-envelope"></i>
          </div>
          <p>yaniarpradityas@gmail.com</p>
        </div>
			</div>
			<div class="contact">
